...
export class CanvasController {
  ...
  setViewpoint(tokenIds) {
    ...
    /* Coalesced: scene switches and init replays call setViewpoint 2-3×
       in a row (owned tokens, then all vision tokens); the microtask
       batches those into one raycast instead of one per call. */
